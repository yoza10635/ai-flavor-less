---
name: ai-flavor-less
description: 中文文本「AI 味/句式指纹」检测器。对章节/文档做六层统计检测（'的'链、模板词对、词性堆叠、骨架重复、排比簇、节奏均匀度、违禁词/情绪直写等），生成逐章节指纹报告与多文件汇总对比，支持基线校准（均值±2σ）。用户提到 AI 味、句式指纹、行文重复度、文风检测、章节质检、去 AI 味检查、网文/通用 profile、校准阈值时使用。
agent_created: true
---
